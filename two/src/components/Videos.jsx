    ...
    <div>
      <Stack direction={['column','row']} h={'100vh'}>
        <VStack w={'full'}>
          ...
          <Text overflowY={'auto'}>This is a sample video for testing and demo.</Text>
        </VStack>
        </VStack>
        ...
        <VStack w={['full','xl']} alignItems={'stretch'} p={'8'} spacing={'8'} overflowY={'auto'}>
          ...
          <Button key={index}  variant={'ghost'} colorScheme='purple' onClick={() => setVideoSrc(item)}>Lecture {index+1}</Button>
